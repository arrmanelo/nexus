...
const css = `
  ...
  .auth-bg-glow {
    ...
    border-radius: 50%;
    background: radial-gradient(circle, rgba(74,255,218,0.06) 0%, transparent 70%);
    top: 50%; left: 50%;
  ...
  .auth-sub {
    font-size: 0.875rem; color: rgba(240,242,255,0.4);
  ...
  .auth-input:focus {
    border-color: rgba(74,255,218,0.4);
  }
  ...
  .auth-btn:hover {
    opacity: 0.9;
    box-shadow: 0 0 30px rgba(74,255,218,0.25);
